insert  into `sys_user`(`USER_ID`,`USERNAME`,`PASSWORD`,`NAME`,`RIGHTS`,`ROLE_ID`,`LAST_LOGIN`,`IP`,`STATUS`,`BZ`,`SKIN`,`EMAIL`,`NUMBER`,`PHONE`,`PIC`,`my_role`) values ('1','admin','5d04d9d2bc43a39b18a76a2660b22a4b4fbb3771','FH','1133671055321055258374707980945218933803269864762743594642571294','1','2017-03-23 17:10:10','0:0:0:0:0:0:0:1','0','admin','default','QQ313596790@main.com','001','18788888888',NULL,NULL),('5a2528f8d5c548728fe54305e06d0cbc','test','b2478239cd7e68e8052398d8eb87d385bf962085','test','','68f8e4a39efe47c7bb869e9d15ab925d','2017-03-23 17:10:43','0:0:0:0:0:0:0:1','0','test','default','4546@qq.com','234245','12345678912',NULL,NULL);
...
insert  into `t_commodity`(`commodity_id`,`user_id`,`store_id`,`commodity_name`,`category`,`price`,`amount`,`location`,`description`,`prefer_num`,`launch_date`,`sales_volume`,`status`) values ('887ac40183344dd497c2c59e4224c448','0d614c1636b34d0aad91d68be1c122cc','','123','123',123,123,'123','123',0,'2017-03-23 15:57:31',0,0);
...
/*Table structure for table `t_schoolcalendar` */

DROP TABLE IF EXISTS `t_schoolcalendar`;

CREATE TABLE `t_schoolcalendar` (
  `schoolcalendar_id` varchar(50) NOT NULL COMMENT '校园日历',
  `brief` varchar(50) DEFAULT NULL COMMENT '概要',
...
/*Data for the table `t_schoolcalendar` */

insert  into `t_schoolcalendar`(`schoolcalendar_id`,`brief`,`location`,`title`,`activity_time`,`add_user`,`add_date`) values ('1d4951af0e9c448ab8aa6256ec7678a0','软一vs计一','广商篮球场','篮球赛','2017-03-22 14:08:00','admin','2017-03-22 14:08:15'),('62531b2b20384b2c86e6141ea9e91e50','网一vs网二','篮球场','篮球赛','2017-03-22 16:35:00','admin','2017-03-22 22:40:22'),('ae789e2d9f02471b9afd6c8722ceb7af','软三vs计三','桌球场','桌球赛','2017-03-24 11:45:00','admin','2017-03-22 22:38:47'),('c396fbe472eb46a6b5eb061617571d8f','软二vs计二','排球场','排球赛','2017-03-20 10:30:00','admin','2017-03-22 22:38:00');
...
insert  into `t_user_info`(`user_id`,`username`,`password`,`phone`,`sex`,`attachment_id`,`year_of_birth`,`ID_num`,`real_name`,`registration_date`,`school`,`shipping_address`,`constellation`,`blood_type`,`head_portrait`,`signature`,`role_id`) values ('0d614c1636b34d0aad91d68be1c122cc','huang','12345','123',1,'4828c0268d9c40a98f9e9c6a9bdd814c',NULL,NULL,NULL,'2017-03-23 15:00:06',NULL,NULL,NULL,NULL,NULL,NULL,NULL),('9aabdf5c0d6f442c8291fe4dfb1eb530','12344444','123','123',1,'8408304d66574ae3aeab52dd044369d2',NULL,NULL,NULL,'2017-03-23 14:59:17',NULL,NULL,NULL,NULL,NULL,NULL,NULL);
