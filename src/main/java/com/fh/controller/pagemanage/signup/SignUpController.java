package com.fh.controller.pagemanage.signup;
...
import com.fh.service.pagemanage.signup.SignUpManager;
...
public class SignUpController extends BaseController {
	...
	String menuUrl = "signup/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"新增SignUp");
	...
	public void delete(PrintWriter out) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"删除SignUp");
	...
	public ModelAndView edit() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"修改SignUp");
	...
	public Object treatAll() throws Exception{
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			...
			for(int i=0;i<ArrayDATA_IDS.length;i++){
				pd.put("MESSAGE_ID", ArrayDATA_IDS[i]);
				pd = signupService.findById(pd);	//根据ID读取
				pd.put("ISHANDLED", 1);
				signupService.edit(pd);
			}	
	...
	public ModelAndView list(Page page) throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"列表SignUp");
		...
		mv.setViewName("pagemanage/signup/signup_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("pagemanage/signup/signup_edit");
	...
	public Object deleteAll() throws Exception{
		logBefore(logger, Jurisdiction.getUsername()+"批量删除SignUp");
		if(!Jurisdiction.buttonJurisdiction(menuUrl, "del")){return null;} //校验权限
		PageData pd = new PageData();		
		Map<String,Object> map = new HashMap<String,Object>();
		pd = this.getPageData();
		...
		if(null != DATA_IDS && !"".equals(DATA_IDS)){
			String ArrayDATA_IDS[] = DATA_IDS.split(",");
			signupService.deleteAll(ArrayDATA_IDS);
			pd.put("msg", "ok");
		}else{
			pd.put("msg", "no");
		}
