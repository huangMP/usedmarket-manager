package com.fh.controller.pagemanage.course;
...
import com.fh.service.pagemanage.course.CourseManager;
...
public class CourseController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		varList = SortUtil.sort(varList, "ADD_TIME", "desc");
		mv.setViewName("pagemanage/course/course_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("pagemanage/course/course_edit");
