 ...
 */
@Controller
@RequestMapping(value="/MakerOriginalityCrowdfunding")
public class MakerOriginalityCrowdfundingController extends BaseController {
	
	String menuUrl = "MakerOriginalityCrowdfunding/list.do"; //菜单地址(权限用)
	...
	public ModelAndView save() throws Exception{
		...
		pd.put("CROWDFUNDING_TYPE" , 1 );    // 设置 类别(1.创意众筹 2.爱心众筹)
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("makermanager/crowdfunding/originality/list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		mv.setViewName("makermanager/crowdfunding/originality/edit");
