 ...
 */
@Controller
@RequestMapping(value="MakerDonationDynamics")
public class MakerDonationDynamicsController extends BaseController {
	
	String menuUrl = "MakerDonationDynamics/list.do"; //菜单地址(权限用)
	...
	public ModelAndView toInsert(){
		...
		mv.setViewName("makermanager/dynamics/donationdynamics/add");
		return mv ;
	}
	...
	public ModelAndView toEdit(String dynamicsId ){
		...
		if(null != dynamics){
			...
			mv.setViewName("makermanager/dynamics/donationdynamics/edit");
			return mv;
		}
		return null;
	}
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("makermanager/dynamics/donationdynamics/list");
