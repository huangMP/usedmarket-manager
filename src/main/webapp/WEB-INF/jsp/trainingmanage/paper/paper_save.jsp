	...
	<div class="main-content">
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<form action="paper/save.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td id="choice_td" hidden="hidden">	
									<div id="choice_answer">
										
									</div>
								</td>
 								<td id="choice_input_td">
 									<input type="text" readonly="readonly" name="CHOICE_ANSWER" id="CHOICE_ANSWER" value="${pd.CHOICE_ANSWER}" maxlength="200" placeholder="请先输入单选题个数" title="选择题答案" style="width:98%;"/>
 								</td>
							</tr>
							...
							<tr>
								...
								<td id="choice_double_td" hidden="hidden">	
									<div id="choice_double_answer">
										
									</div>
								</td>
 								<td id="choice_input_double_td"><input readonly="readonly" type="text" name="CHOICE_DOUBLE_ANSWER" id="CHOICE_DOUBLE_ANSWER" value="${pd.CHOICE_DOUBLE_ANSWER}" maxlength="200" placeholder="请先输入多选题个数" title="选择题答案" style="width:98%;"/>
 								</td>
							</tr>
							...
							<tr>
								...
								<td id="fill_td" hidden="hidden">	
									<div id="fill_answer">
										
									</div>
								</td>
								<td id="fill_input_td"><input readonly="readonly" type="text" name="FILL_ANSWER" id="FILL_ANSWER" value="${pd.FILL_ANSWER}" maxlength="200" placeholder="请先输入填空题个数" title="填空题答案" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td id="subjective_td" hidden="hidden">	
									<div id="subjective_answer">
										
									</div>
								</td>
								<td id="subjective_textarea_td"><textarea readonly="readonly" rows="5" cols=""  name="SUBJECTIVE_ANSWER" id="SUBJECTIVE_ANSWER" placeholder="请先输入主观题个数" title="主观题答案" style="width:98%;">${pd.SUBJECTIVE_ANSWER}</textarea></td>
							</tr>
