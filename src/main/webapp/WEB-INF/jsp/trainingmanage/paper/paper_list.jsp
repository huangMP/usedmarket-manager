...
<body class="no-skin">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">	
							<thead>
								<tr>
									...
									<th class="center">单选题分数</th>
									<th class="center">单选题答案</th>
									<th class="center">多选题个数</th>
									<th class="center">多选题分数</th>
									<th class="center">多选题答案</th>
									<th class="center">填空题个数</th>
									<th class="center">填空题分数</th>
									<th class="center">填空题答案</th>
									<th class="center">主观题个数</th>
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${var.PAPER_ID}" class="ace" /><span class="lbl"></span></label>
											</td>
											...
											<td class='center'>${var.CHOICE_DOUBLE_NUM}</td>
											<td class='center'>${var.CHOICE_DOUBLE_GRADE}</td>
											<td class='center'>${var.CHOICE_DOUBLE_ANSWER}</td>
											<td class='center'>${var.FILL_NUM}</td>
											<td class='center'>${var.FILL_GRADE}</td>
											<td class='center'>${var.FILL_ANSWER}</td>
											<td class='center'>${var.SUBJECTIVE_NUM}</td>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<c:if test="${QX.edit == 1 }">
													<a class="btn btn-xs btn-success" title="编辑" onclick="edit('${var.PAPER_ID}');">
														<i class="ace-icon fa fa-pencil-square-o bigger-120" title="编辑"></i>
													</a>
													</c:if>
													<c:if test="${QX.del == 1 }">
													<a class="btn btn-xs btn-danger" onclick="del('${var.PAPER_ID}');">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<c:if test="${QX.edit == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="edit('${var.PAPER_ID}');" class="tooltip-success" data-rel="tooltip" title="修改">
																	<span class="green">
															...
															<c:if test="${QX.del == 1 }">
															<li>
																<a style="cursor:pointer;" onclick="del('${var.PAPER_ID}');" class="tooltip-error" data-rel="tooltip" title="删除">
																	<span class="red">
	...
	<script type="text/javascript">
		...
		//导出excel
		function toExcel(){
			window.location.href='<%=basePath%>paper/excel.do';
		}
	</script>
