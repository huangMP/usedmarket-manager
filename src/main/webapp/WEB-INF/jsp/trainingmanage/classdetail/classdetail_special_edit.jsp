		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
											<tr>
												...
												<td class='center'>
													<c:if test="${QX.edit == 1 }">
														<a class="btn btn-xs btn-danger" onclick="delSpecial('${pd.CLASSDETAIL_ID}','${var.SPECIAL_ID}');">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.del == 1 }">
									<a class="btn btn-sm btn-danger" onclick="delSpecialAll('${pd.CLASSDETAIL_ID}');">移除专题</a>
									</c:if>
					...
					<form action="classdetail/${msg }.do" name="Form" id="Form" method="post">
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		function delSpecial(clsId,spId){
			
			$.ajax({
				url:'<%=basePath%>classdetail/delSpecial.do?CLASSDETAIL_ID='+clsId+'&SPECIAL_ID='+spId,
		...
		function delSpecialAll(clsId){
			...
			if(str==''){
				...
				$.ajax({
					type: "POST",
					url: '<%=basePath%>classdetail/delSpecialAll.do?CLASSDETAIL_ID='+clsId+'&tm='+new Date().getTime(),
			    	data: {DATA_IDS:str},
					dataType:'json',
