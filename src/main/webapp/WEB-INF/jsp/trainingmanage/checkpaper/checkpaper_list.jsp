...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="checkpaper/list.do" method="post" name="Form" id="Form">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													<a class="btn btn-xs btn-success" title="审核" onclick="Check('${var.USERANDSPECIAL_ID}');">
														<i class="ace-icon glyphicon glyphicon-list-alt bigger-110" title="审核"></i>
													</a>
												</div>
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a style="cursor:pointer;" onclick="Check('${var.USERANDSPECIAL_ID}');" class="tooltip-success" data-rel="tooltip" title="审核">
																	<span class="green">
	...
	<script type="text/javascript">
		...
		function Check(Id){
			 ...
			 diag.Drag=true;
			 diag.Title ="审核";
			 diag.URL = '<%=basePath%>checkpaper/goCheck.do?USERANDSPECIAL_ID='+Id;
			 diag.Width = 600;
			 diag.Height = 600;
