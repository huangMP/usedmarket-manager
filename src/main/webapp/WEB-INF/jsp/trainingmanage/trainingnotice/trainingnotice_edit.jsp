						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td>
									...
									<textarea rows="27" cols="" Id="showText" placeholder="这里输入正文(不超过3000字)" type="text" name="TEXTAREA"
										title="正文" style="width:98%;">${pd.TEXT}</textarea>
									<input id="TEXT" id="TEXT" type="hidden" class="form-control" name="TEXT" value="">
									<input value="建议不超过650字"  class="form-control" readonly="readonly"/>
								</td>
							</tr>
							<tr>
							...
							<input hidden="hidden" type="number" name="SORT" id="SORT" value="${pd.SORT}" maxlength="32" placeholder="这里输入优先数" title="优先数" style="width:98%;"/>
							<input hidden="hidden" type="text" name="ADD_USER" id="ADD_USER" value="${pd.ADD_USER}" maxlength="50" placeholder="这里输入添加人" title="添加人" style="width:98%;"/>
							<input hidden="hidden" class="span10 date-picker" name="ADD_TIME" id="ADD_TIME" value="${pd.ADD_TIME}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="添加时间" title="添加时间" style="width:98%;"/>
							<tr>
