...
<html>
  ...
  <body>
              这是法规与标准页面.
     <hr>            
     <span><button id="4"  onclick="switchFun(this);">法规</button></span>
     <br>
     <span><button id="5"  onclick="switchFun(this);">标准</button></span>
     <br>
     <span><button id="6"  onclick="switchFun(this);">相关文件</button></span>
     <br>
     <div>
