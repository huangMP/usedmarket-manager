...
<div class="content">
    <div class="local">
        <span>当前位置：<a href="app_index/goindex">普宁档案</a>>><a href="app_index/goArchiveIntroduction">局馆介绍</a><span>>>领导关怀</span></span>
    </div>
    <div class="details">
        <div class="navBox">
            <h2>局馆介绍</h2>
            <ul class="nav_option">
                ...
                <li><a href="app_index/goLeadershipConcern" class="active">领导关怀</a></li>
            </ul>
        </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		function getPageData(){
			...
			$.ajax({
				type: "post",
            	url: "<%=basePath%>app_photoalbum/list.do"+"?showCount="+showCount_val+"&currentPage="+currentPage_val+"&keywords=3",
