...
<div class="content">
    <div class="local">
        <span>当前位置：<a href="app_index/goindex">普宁档案</a>>><a href="app_index/goArchiveIntroduction">局馆介绍</a><span>>>领导班子</span></span>
    </div>
    <div class="details">
        <div class="navBox">
            <h2>局馆介绍</h2>
            <ul class="nav_option">
                ...
                <li><a href="app_index/goLeadershipRanks" class="active">领导班子</a></li>
...
<script type="text/javascript">
  ...
  $().ready(function(){
      $.ajax({
			type: "POST",
			url: '<%=basePath%>app_doc/getDocList.do?type=1&tm='+new Date().getTime()+'&currentPage=1&showCount=15',
    ...
    function switchPage(page){
   	 $.ajax({
			type: "POST",
			url: '<%=basePath%>app_doc/getDocList.do?type=1'+'&tm='+new Date().getTime()+'&currentPage='+page+'&showCount=15',
	    	data: {},
			dataType:'json',
			cache: false,
			success: function(data){
