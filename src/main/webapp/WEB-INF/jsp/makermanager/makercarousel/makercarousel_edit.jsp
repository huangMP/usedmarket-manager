		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="makercarousel/${msg }.do" name="Form" id="Form" method="post">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td id="pictureList">
									<a class="btn btn-sm btn-success" onclick="addPictures_( '${pd.CAROUSEL_ID}' );">新增</a>
									<br/>
								</td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">轮播图标题:</td>
								<td><input type="text" name="TITLE" id="TITLE" value="${pd.TITLE}" maxlength="255" placeholder="这里输入轮播图标题" title="轮播图标题" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">位置:</td>
								<td><input type="number" name="SORT" id="SORT" value="${pd.SORT}" maxlength="32" placeholder="这里输入位置" title="位置" style="width:98%;"/></td>
							</tr>
...
<!-- /.main-container -->
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
		...
		$(function () {
			var contentId_ =  $("#CAROUSEL_ID").attr("value");
