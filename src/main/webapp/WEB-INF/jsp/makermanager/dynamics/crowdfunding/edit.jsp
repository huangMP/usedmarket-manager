...
<head>
    ...
    <link href="<%=basePath%>static/static/bootstrap/css/bootstrap.css" rel="stylesheet" media="screen">
    <link href="<%=basePath%>static/static/css/font-awesome.min.css" rel="stylesheet" media="screen">
...
<script type="text/javascript">
    ...
    $("#submitButton").click(function(){
        ...
        $.ajax({
            type: 'post',
            url: '<%=basePath%>MakerCrowdfundingDynamics/update',
