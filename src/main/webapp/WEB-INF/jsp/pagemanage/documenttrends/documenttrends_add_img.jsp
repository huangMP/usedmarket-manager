		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="documenttrends/${msg }.do?DOCUMENT_ID=${pd.DOCUMENT_ID}" name="Form" id="Form" method="post" enctype="multipart/form-data">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<c:if test="${choice == -1 }">
									<td><input type="number" name="TYPE" id="TYPE" value="${pd.TYPE}" maxlength="32" placeholder="这里输入分类" title="分类" style="width:98%;" disabled="true"/></td>
								</c:if>
								<c:if test="${choice >= 0 }">
								<td>
							...
							<tr>
										...
										<tr>
											...
											<td id="imgcontext">
											<input type="hidden" id="IMG_PATH" value="${pd.IMG_PATH}" />
													<c:choose>  
										...
										<tr>
											...
											<td><textarea rows="27" cols="" placeholder="这里输入正文(不超过3000字)" type="text" name="TEXT"
													id="TEXT" title="正文" style="width:98%;">${pd.TEXT}</textarea></td>
										</tr>
											...
											<input hidden="hidden" type="text" name="SORT" id="SORT" value="${pd.SORT}" />
										<tr>
