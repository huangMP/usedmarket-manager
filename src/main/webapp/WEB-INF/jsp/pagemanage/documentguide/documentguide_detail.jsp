					...
					<div class="col-xs-12">
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							<tr>
								...
								<td><input disabled="disabled" type="text" name="TITLE" id="TITLE" value="${pd.TITLE}" maxlength="100" placeholder="这里输入标题" title="标题" style="width:98%;"/></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input disabled="disabled" type="text" name="ADD_USER" id="ADD_USER" value="${pd.ADD_USER}" maxlength="100" placeholder="这里输入添加人" title="添加人" style="width:98%;"/></td>
							</tr>
							<tr>
