		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="connection/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="CONNECTION_ID" id="CONNECTION_ID" value="${pd.CONNECTION_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="PHONE" id="PHONE" value="${pd.PHONE}" maxlength="50" placeholder="这里输入电话" title="电话" style="width:98%;"/></td>
							</tr>
							<tr>
								<td style="width:75px;text-align: right;padding-top: 13px;">传真:</td>
								<td><input type="text" name="FAX" id="FAX" value="${pd.FAX}" maxlength="50" placeholder="这里输入传真" title="传真" style="width:98%;"/></td>
							</tr>
							<tr>
