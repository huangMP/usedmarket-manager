		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="link/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="LINK_ID" id="LINK_ID" value="${pd.LINK_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="text" name="URL" id="URL" value="${pd.URL}" maxlength="100" placeholder="这里输入链接" title="链接" style="width:98%;"/></td>
							</tr>
							<tr>
